        ...
        if not diff_df.empty:
            ...
            if is_stock:
                ...
                for idx in range(len(diff_df)):
                    ...
                    # Add to checklist if blue (but only if NOT yellow, and not for Removal/Add Composition/Rights Issue)
                    if new_shares_blue and not new_shares_yellow and adj_rsn not in ("Removal", "Add Composition", "Rights Issue"):
                    ...
                    try:
                        ...
                        close_prc_red = (close_prc_numeric is None or close_prc_numeric == 0) and adj_rsn not in ('Removal', 'Add Composition')
                    except (ValueError, TypeError):
                        close_prc_red = adj_rsn not in ('Removal', 'Add Composition')
