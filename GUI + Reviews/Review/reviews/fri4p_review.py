...
def run_fri4p_review(date, co_date, effective_date, index="FRI4P", isin="FRIX00003643", 
    ...
    try:
        ...
        # Fill NaN with 0 for ranking columns (match colleague's approach)
        ...
        # NOTE: FRI4P does NOT have SBT/NACE exclusion (unlike FRD4P)
        ...
        for (sector, area), group in developed_market_df.groupby(['Supersector Code', 'Area Flag']):
            ...
            n_to_exclude = int(np.floor(n_companies * 0.20))
