...
def run_lc3wp_review(date, co_date, effective_date, index="LC3WP", isin="FR0013522588", 
                    area="US", area2="EU", type="STOCK", universe="Euronext World", 
                    feed="Reuters", currency="EUR", year=None):
    """
    Run the Low Carbon 300 World PAB index review calculation
    ...
    Args:
        ...
        index (str, optional): Index name. Defaults to "LC3WP".
        isin (str, optional): ISIN code. Defaults to "FR0013522588".
        ...
        universe (str, optional): Universe name. Defaults to "Euronext World".
    ...
    try:
        ...
        required_dfs = ['euronext_world_df', 'ff_df', 'icb_df', 'cdp_climate_df', 
        ...
        universe_df = euronext_world_df.rename(columns={
            'Name': 'Company',
            'ISIN': 'ISIN Code',
        ...
        target_constituents = 300  # As mentioned in the prompt
        ...
        output_path = os.path.join(output_dir, f'LC3WP_review_{timestamp}.xlsx')
