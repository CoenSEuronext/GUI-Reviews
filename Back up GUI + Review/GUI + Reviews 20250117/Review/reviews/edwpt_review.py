...
def run_edwpt_review(date, effective_date, index="EDWPT", isin="NLIX00001932", 
    ...
    try:
        ...
        # Create EDWPT_df from selected companies
        EDWPT_df = universe_df[universe_df['EDWPT_selection'] == 1][['Name', 'ISIN', 'MIC', 'NOSH', 'Free Float', 'Final Capping', 'Effective Date of Review', 'Currency (Local)']].copy()
