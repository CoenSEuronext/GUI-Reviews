...
def run_eesf_review(date, co_date, effective_date, index="EESF", isin="NLIX00006170", 
    ...
    try:
        ...
        # European Defense/Industrial universe
        eesf_universe = [
            ...
            {'Company': 'AP MOELLER - MAERSK', 'ISIN': 'DK0010244508', 'MIC': 'XCSE', 'Currency': 'DKK'},
            ...
            {'Company': 'ROLLS-ROYCE HOLDINGS', 'ISIN': 'GB00B63H8491', 'MIC': 'XLON', 'Currency': 'GBP'},
            ...
            {'Company': 'ARCELORMITTAL SA', 'ISIN': 'LU1598757687', 'MIC': 'XAMS', 'Currency': 'EUR'},
        ...
        eesf_df = pd.DataFrame(eesf_universe)
        ff_df = ref_data['ff']

        
        # Add the required columns to the combined dataframe
        eesf_df['Capping Factor'] = 1
        eesf_df['Effective Date of Review'] = effective_date
        ...
        top_n = 20  # 20 companies in EESF universe
        ...
        try:
            ...
            eesf_path = os.path.join(output_dir, f'EESF_df_{timestamp}.xlsx')
           
            # Save output with multiple sheets
            logger.info(f"Saving EESF output to: {eesf_path}")
            with pd.ExcelWriter(eesf_path) as writer:
                EESF_df.to_excel(writer, sheet_name='Index Composition', index=False)
